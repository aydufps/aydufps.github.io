...
async function tomarCorreo() {
    ...
    const respuesta = await fetch("https://aydfincas.herokuapp.com/mail", {
        method: "POST",
    ...
    let string = "<class=`alert alert-info` role=`alert`>";
    string += respuesta;
    string += "</div>";
...
window.onload = async function () {
    ...
    document.querySelector("#Enviar-clave").addEventListener("click", tomarCorreo);
